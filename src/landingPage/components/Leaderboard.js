...
function Leaderboard() {
  ...
  return (
    <>
      <div className=" py-8 bg-gradient-to-r from-dark-yellow to-light-yellow  space-x-10 ">
        <h2 className="text-center text-4xl md:py-6 py-2 text-shrink ">
          Magic Leaderboard
        </h2>

        <div className="md:flex hidden gap-4 items-center my-6 w-11/12 mx-auto">
          <OwlCarousel {...options}>
        ...
        <div className="  w-10/12 mx-auto md:hidden   overflow-hidden ">
